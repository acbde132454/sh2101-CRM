	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form id="tranForm" class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <button type="button" class="btn btn-default" onclick="tranQuery()">查询</button>
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='/crm/workbench/transaction/toDetail?id=cf3ba5432ea344398eb12f9bd0def903';">动力节点-交易01</a></td>
							<td>动力节点</td>
							<td>谈判/复审</td>
							<td>新业务</td>
							<td>zhangsan</td>
...
<script>
	//点击查询按钮，发送异步查询
	function tranQuery() {
		$.post("/crm/workbench/tran/tranQuery",$('#tranForm').serialize(),function(data){
		},'json')
